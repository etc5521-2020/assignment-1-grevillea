...
### "Le Tour" Distance Through History {-#mysection}
...
dist_plot <- ggplot(dist_data) +
  ...
  labs(x = "Year",
       y = "Distance (km)",
       title = "The History of Tour de France Distance",
...
ggMarginal(dist_plot, margins = 'y', size=4, type = "histogram", fill = "steelblue", color = "white" )
