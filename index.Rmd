...
# Tour De France Data {-#mysection}

## Getting the Data (and Debugging Process) {-#mysection}
...
winners %>%
  ...
  geom_col(width = 0.8,
           ...
           fill = "#85929E") +
  labs(x = NULL, y = NULL) +
  ggtitle("The number of times the rider win the Tour de France") +
...
stages_joined %>%
  ...
  ungroup() %>%
  ggplot(aes(cumulatice_points, rider)) +
  geom_col() +
