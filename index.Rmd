...
If we look at the marginal histogram on the right side of the plot, we can also conclude that the distribution of Tour de France distance is multimodal. In the first three decades of the competition, the most frequent distance is around 5500 km. After that, the most frequent distances decreased to about 4500 km and 4000 km. Finally, it went down again to around 3500 km.
